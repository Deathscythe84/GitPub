...
<body>
	...
	<form name="insertbar" method="post" action="db/InsertIntoPub.php">
		...
		Address2: <input type="text" name="Padd2" pattern="[A-Za-z\s]+" title="Can only contain letters" /></br>
		Address3: <input type="text" name="Padd3" pattern="[A-Za-z\s]+" title="Can only contain letters" /></br>
		City: <input type="text" name="Pcity" pattern="[A-Za-z\s]+" title="Can only contain letters" required /></br>
		Country: <input type="text" name="Pcountry" pattern="[A-Za-z\s]+" title="Can only contain letters" required /></br>
