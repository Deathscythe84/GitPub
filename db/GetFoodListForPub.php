...
$FoodListQuery = "select * from getfoodforpub Where pid =".$PID;

//$FoodListQuery = "select Food_ID,Food_Name From Food where Food_ID IN (Select Food_ID From Food_List Where Pub_ID =".$PID.")";
