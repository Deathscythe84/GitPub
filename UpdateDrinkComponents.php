				...
				<div class="container">
					...
					<div class="row">
						<div id="contentLeft" class="one-half column"> <!--Display your content in this section-->
							<select id="DrinkList" onchange="getDrinkTableComponents()"></select>
						...
						<div id="contentRight" hidden class="one-half column"> <!--Display your content in this section-->
							...
							<select id="DrinkComponents"></select> 
							<button type="button" onclick="RemoveDrinkComponent()">Remove</button>
							<hr>
							
							<form id="insertdrinkcomp" action="javascript:addComponentToDrink()">
